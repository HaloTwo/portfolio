...
### 💻 Programming
- C#
- C++ (Unreal Gameplay 구현 경험)
- Object-Oriented Programming (OOP)

### 🎯 Gameplay
- Combat System 구현
- AI (Behavior Tree, State Pattern)
- Interaction System (탑승 / 상호작용 기능)
- Camera View Switching 구현

### 💾 Data & Save
- JSON 기반 Save/Load 시스템
- Hybrid Save 구조 (JSON + PlayerPrefs)
- Save Data 검증 및 자동 보정 로직
- 오프라인 보상 시간 계산 시스템

### ⚡ Optimization
- Object Pool / Component Pool 구현
- 100+ NPC 환경 성능 최적화 경험
- 비동기 데이터 처리

### 🛠 Tools
- Git / GitHub / GitFlow
- Unity Custom Editor Tool 제작
- Firebase / Google Sheet API 연동
